...
public class Msproductdetail {
	...
	private String productplace;//��Ʒ����
	private String productname;//��Ʒ����
	private String brandname;//��ƷƷ��
	private String productweight;//��Ʒ����
	private String specification;//���Ͱ�װ
	private String productdetailpicture;//����ͼƬ��ַ
	public int getId() {
		return id;
	}
