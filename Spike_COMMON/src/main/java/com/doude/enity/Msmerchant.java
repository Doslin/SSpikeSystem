...
public class Msmerchant {
	...
	private int id;//����
	private String merchantname;//�̼ҵ�����
	private String merchantaccount;//�̼��˺�
	private String merchantpassword;//�̼�����
	private String merchantscope;//�̼Ҿ�Ӫ��Χ
	private String merchantshopname;//�̼ҵĵ�������
	public int getId() {
		return id;
	}
